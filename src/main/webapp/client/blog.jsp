                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="${pageContext.request.contextPath}/client/blog.jsp" class="dropdown-item active">Blog Grid</a>
        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                    ...
                    <h1 class="display-5 text-uppercase mb-0">Latest Articles From Our Blog</h1>
                </div>
                <div class="row g-5">
                    <!-- Blog list Start -->
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-md-6">
                                <div class="blog-item">
                                    <div class="position-relative overflow-hidden">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/client/assets/img/blog-1.jpg" alt="">
                                    </div>
                                    <div class="bg-light p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i class="bi bi-person me-2"></i>Admin</small>
                                            <small><i class="bi bi-calendar-date me-2"></i>01 Jan, 2023</small>
                                        </div>
                                        <h5 class="text-uppercase mb-3">Essential Pet Grooming Tips for a Healthy Coat</h5>
                                        <p>Learn how regular grooming can improve your pet's health and well-being. We cover brushing techniques, bathing tips, and more!</p>
                                        <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/detail.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="blog-item">
                                    <div class="position-relative overflow-hidden">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/client/assets/img/blog-2.jpg" alt="">
                                    </div>
                                    <div class="bg-light p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i class="bi bi-person me-2"></i>Admin</small>
                                            <small><i class="bi bi-calendar-date me-2"></i>15 Jan, 2023</small>
                                        </div>
                                        <h5 class="text-uppercase mb-3">Nutrition Guide: Choosing the Right Diet for Your Pet</h5>
                                        <p>Discover how to select the best food for your pet based on their age, breed, and health needs. Expert nutrition advice and recommendations.</p>
                                        <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/detail.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="blog-item">
                                    <div class="position-relative overflow-hidden">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/client/assets/img/blog-3.jpg" alt="">
                                    </div>
                                    <div class="bg-light p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i class="bi bi-person me-2"></i>Admin</small>
                                            <small><i class="bi bi-calendar-date me-2"></i>01 Feb, 2023</small>
                                        </div>
                                        <h5 class="text-uppercase mb-3">Pet Training 101: Basic Commands Every Dog Should Know</h5>
                                        <p>Our pet trainers share effective methods for teaching your dog essential commands that will make your life together easier and more enjoyable.</p>
                                        <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/detail.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="blog-item">
                                    <div class="position-relative overflow-hidden">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/client/assets/img/blog-4.jpg" alt="">
                                    </div>
                                    <div class="bg-light p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i class="bi bi-person me-2"></i>Admin</small>
                                            <small><i class="bi bi-calendar-date me-2"></i>15 Feb, 2023</small>
                                        </div>
                                        <h5 class="text-uppercase mb-3">Caring for Senior Pets: Special Needs and Considerations</h5>
                                        <p>As pets age, their care requirements change. Learn how to support your senior pet's health, mobility, and comfort in their golden years.</p>
                                        <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/detail.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="blog-item">
                                    <div class="position-relative overflow-hidden">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/client/assets/img/blog-5.jpg" alt="">
                                    </div>
                                    <div class="bg-light p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i class="bi bi-person me-2"></i>Admin</small>
                                            <small><i class="bi bi-calendar-date me-2"></i>01 Mar, 2023</small>
                                        </div>
                                        <h5 class="text-uppercase mb-3">Pet-Proofing Your Home: Safety Tips for New Pet Owners</h5>
                                        <p>Make your home safe for your new furry family member with these essential tips on identifying and eliminating common household hazards.</p>
                                        <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/detail.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="blog-item">
                                    ...
                                    <div class="bg-light p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i class="bi bi-person me-2"></i>Admin</small>
                                            <small><i class="bi bi-calendar-date me-2"></i>15 Mar, 2023</small>
                                        </div>
                                        <h5 class="text-uppercase mb-3">Seasonal Pet Care: Protecting Your Pet Through the Year</h5>
                                        <p>Each season brings different challenges for pet care. Learn how to keep your pet safe and comfortable no matter what the weather brings.</p>
                                        <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/detail.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
