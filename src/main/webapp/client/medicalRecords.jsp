...
<!DOCTYPE html>
<html lang="en">
    <jsp:include page="/clients/assets/layout/headerFull.jsp"/>
    ...
    <body>
        <div class="container py-5">
            <div class="mb-3">
                <a href="userdetail?action=getUserDetail" class="btn btn-outline-secondary">
                ...
                <c:forEach var="mr" items="${medicalRecords}">
                    <div class="col-12 mb-3">
                        <div class="card shadow-sm p-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <a href="medicalrecords?action=getMedicalDetail&medicalRecordID=${mr.medicalRecordsID}" class="btn btn-outline-success btn-sm" style="height:max-content;">View Details</a>
                        </div>
                    </div>
                </c:forEach>
