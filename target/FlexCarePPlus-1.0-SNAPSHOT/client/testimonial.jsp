                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="${pageContext.request.contextPath}/client/testimonial.jsp" class="dropdown-item active">Testimonial</a>
        ...
        <div class="container-fluid bg-testimonial py-5" style="margin: 45px 0;">
            <div class="container py-5">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px; background: rgba(255, 255, 255, 0.9);">
                            <h6 class="text-primary text-uppercase">Testimonial</h6>
                            <h1 class="display-5 text-uppercase mb-0">Our Happy Clients Say About Us</h1>
                        </div>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="bg-white p-4">
                                        ...
                                        <p>The team at FlexCarePPlus has been wonderful with my dog Max. After just a few sessions with their trainer, we saw significant improvement in his behavior. The facilities are always clean, and the staff is friendly and professional.</p>
                                        <div class="d-flex align-items-center">
                                            <img class="img-fluid flex-shrink-0 rounded-circle" src="${pageContext.request.contextPath}/client/assets/img/testimonial-1.jpg" style="width: 50px; height: 50px;">
                                            <div class="ps-3">
                                                <h6 class="text-uppercase mb-1">Client Name</h6>
                                ...
                                <div class="carousel-item">
                                    <div class="bg-white p-4">
                                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                                        <p>I've been bringing my cat to FlexCarePPlus for grooming for the past year. They handle her with such care, and the grooming results are always excellent. I also appreciate their flexible scheduling options, which is perfect for my busy lifestyle.</p>
                                        <div class="d-flex align-items-center">
                                            <img class="img-fluid flex-shrink-0 rounded-circle" src="${pageContext.request.contextPath}/client/assets/img/testimonial-2.jpg" style="width: 50px; height: 50px;">
                                            <div class="ps-3">
                                                <h6 class="text-uppercase mb-1">Client Name</h6>
                                                <span>Profession</span>
                                            </div>
                                ...
                                <div class="carousel-item">
                                    <div class="bg-white p-4">
                                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                                        <p>When I needed boarding services for my pet during my vacation, I was nervous about leaving him. FlexCarePPlus sent me daily updates with photos, which gave me peace of mind. My pet returned happy and well-cared for. I couldn't ask for better service!</p>
                                        <div class="d-flex align-items-center">
                                            <img class="img-fluid flex-shrink-0 rounded-circle" src="${pageContext.request.contextPath}/client/assets/img/testimonial-3.jpg" style="width: 50px; height: 50px;">
                                            <div class="ps-3">
                                                <h6 class="text-uppercase mb-1">Client Name</h6>
                                                <span>Profession</span>
                                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="border-start border-5 border-primary ps-5 mb-5">
                            <h6 class="text-primary text-uppercase">Request A Quote</h6>
                            <h1 class="display-5 text-uppercase mb-0">Request A Quote for Your Pet Service Needs</h1>
                        </div>
                        <div class="bg-light p-5">
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control bg-white border-0" placeholder="Service Type" style="height: 55px;">
                                    </div>
                                    <div class="col-12">
