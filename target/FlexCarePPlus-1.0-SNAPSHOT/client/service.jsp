...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>FlexCarePPlus - Our Services</title>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="${pageContext.request.contextPath}/client/service.jsp" class="nav-item nav-link active">Service</a>
                ...
                <div class="row g-5">
                    <div class="col-md-6">
                        <div class="service-item bg-light d-flex p-4">
                            ...
                            <div>                            <h5 class="text-uppercase mb-3">Pet Boarding</h5>
                                <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                                <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/service.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-item bg-light d-flex p-4">
                            ...
                            <div>                            <h5 class="text-uppercase mb-3">Pet Feeding</h5>
                                <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                                <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/service.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="service-item bg-light d-flex p-4">
                            ...
                            <div>                            <h5 class="text-uppercase mb-3">Pet Grooming</h5>
                                <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                                <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/service.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="service-item bg-light d-flex p-4">
                            ...
                            <div>                            <h5 class="text-uppercase mb-3">Pet Training</h5>
                                <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                                <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/service.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="service-item bg-light d-flex p-4">
                            ...
                            <div>                            <h5 class="text-uppercase mb-3">Pet Exercise</h5>
                                <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                                <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/service.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="service-item bg-light d-flex p-4">
                            ...
                            <div>                            <h5 class="text-uppercase mb-3">Pet Treatment</h5>
                                <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                                <a class="text-primary text-uppercase" href="${pageContext.request.contextPath}/client/service.jsp">Read More<i class="bi bi-chevron-right"></i></a>
                            </div>
                        </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <h6 class="text-uppercase mt-4 mb-3">Follow Us</h6>                    <div class="d-flex">
                            <a class="btn btn-outline-primary btn-square me-2" href="${pageContext.request.contextPath}/client/service.jsp"><i class="bi bi-twitter"></i></a>
                            <a class="btn btn-outline-primary btn-square me-2" href="${pageContext.request.contextPath}/client/service.jsp"><i class="bi bi-facebook"></i></a>
                            <a class="btn btn-outline-primary btn-square me-2" href="${pageContext.request.contextPath}/client/service.jsp"><i class="bi bi-linkedin"></i></a>
                            <a class="btn btn-outline-primary btn-square" href="${pageContext.request.contextPath}/client/service.jsp"><i class="bi bi-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
